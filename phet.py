...
def NOTIFIED_ACCEPT_GROUP_INVITATION(op):
    #print op
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + "ยินดีต้อนรับเข้ากลุ่ม " + group.name)
    except Exception as e:
        print e
